...
func main() {
	...
	if err != nil {
		log.Fatalln(err)
		// Тут можно сделать вместо выхода из программы сделать присвоение дефолтного кол-во воркеров
	}

	ch := make(chan int, 12) // Создаем буферизированный канал типа int с определённой вместимостью
